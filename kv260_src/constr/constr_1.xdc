...
set_property PACKAGE_PIN G6 [get_ports MISO_a_p]
set_property PACKAGE_PIN E5 [get_ports scl_p]
set_property PACKAGE_PIN G8 [get_ports MOSI_p]
set_property PACKAGE_PIN F8 [get_ports MISO_b_p]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports MISO_a_p]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports MISO_a_n]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports MISO_b_p]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports MOSI_p]
